...
class WaveHyperNWEnhanced(IStrategy):
    ...
    max_drawdown_protection = DecimalParameter(0.05, 0.15, default=0.10, space="protection")
    ...
    def populate_indicators(self, dataframe, metadata):
        ...
        # Nadaraya-Watson melhorado
        dataframe['nw_estimate'], dataframe['nw_upper'], dataframe['nw_lower'] = self.nadaraya_watson(dataframe)
    ...
    def populate_entry_trend(self, dataframe, metadata):
        ...
        volume_ok = (
            ...
            (dataframe['volume_momentum'] > -0.2)  # Volume não em queda livre
        )
    ...
    def populate_exit_trend(self, dataframe, metadata):
        ...
        profit_taking = (
            (dataframe['close'] > dataframe['ema_8'] * 1.04) |  # 4% acima da EMA
